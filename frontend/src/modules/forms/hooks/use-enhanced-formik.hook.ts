...
import { useFormErrors } from 'modules/forms/hooks/use-form-errors.hook';
...
export interface UseEnhancedFormikInterface<Values> extends ReturnType<typeof useFormik> {
